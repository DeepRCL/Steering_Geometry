...
| Qwen3.5-9B Base     | OPT            | A/B next-token           | 42.9%         | 52.5%             | +9.6 pp   | —             | 40         | —                                                                                              |
| Qwen3.5-9B Base     | OPT            | Full-answer mean logprob | 48.4%         | 77.3%             | +29.0 pp  | —             | 40         | —                                                                                              |
| Qwen3.5-9B Base     | Cold-Steer     | A/B next-token           | 45.1%         | 50.6%             | +5.5 pp   | —             | 40         | —                                                                                              |
| Qwen3.5-9B Base     | ODE-Steer      | A/B next-token           | 43.6%         | 53.3%             | +9.7 pp   | —             | 40         | —                                                                                              |
| Qwen3.5-9B Base     | ODE-Steer      | Full-answer mean logprob | 48.4%         | 65.2%             | +16.8 pp  | —             | 20         | —                                                                                              |
...
| Qwen3.5-9B Instruct | OPT            | A/B next-token           | 47.4%         | 52.0%             | +4.6 pp   | —             | 40         | —                                                                                              |
| Qwen3.5-9B Instruct | OPT            | Full-answer mean logprob | 43.3%         | 61.1%             | +17.8 pp  | —             | 40         | —                                                                                              |
| Qwen3.5-9B Instruct | Cold-Steer     | A/B next-token           | 48.6%         | 52.0%             | +3.4 pp   | —             | 40         | —                                                                                              |
| Qwen3.5-9B Instruct | ODE-Steer      | A/B next-token           | 48.2%         | 48.2%             | +0.0 pp   | —             | 40         | —                                                                                              |
...
This table uses the five geometry metrics from `geometry_metrics.json`. `Raw LLM activations` is unsteered positive-answer activation geometry.


| Model               | Method              | spearman_rho | pearson_r | rho_H   | Delta_pol |
| ------------------- | ------------------- | ------------ | --------- | ------- | --------- |
| Qwen3.5-9B Base     | Raw LLM activations | 0.2228       | 0.2087    | 0.2115  | 0.0009    |
| Qwen3.5-9B Base     | OPT                 | 0.1138       | 0.1104    | 0.0493  | 0.0001    |
| Qwen3.5-9B Base     | Cold-Steer (FD)     | 0.0265       | -0.0100   | 0.0013  | 0.0162    |
| Qwen3.5-9B Base     | ODE-Steer           | 0.2730       | 0.2963    | 0.2988  | 0.0255    |
| Qwen3.5-9B Base     | SphericalSteer      | 0.3962       | 0.4061    | 0.2746  | 0.3620    |
| Qwen3.5-9B Base     | CAA                 | 0.4599       | 0.4750    | 0.3407  | 0.3874    |
| Qwen3.5-9B Base     | SparseCAA           | 0.4584       | 0.4520    | 0.4392  | 0.4215    |
| Qwen3.5-9B Instruct | Raw LLM activations | 0.1253       | 0.1112    | 0.1455  | 0.0004    |
| Qwen3.5-9B Instruct | OPT                 | 0.0615       | 0.0552    | -0.0177 | -0.0099   |
| Qwen3.5-9B Instruct | Cold-Steer (FD)     | -0.0568      | -0.0394   | -0.0268 | 0.1401    |
| Qwen3.5-9B Instruct | ODE-Steer           | 0.2055       | 0.2177    | 0.2495  | 0.0176    |
| Qwen3.5-9B Instruct | SphericalSteer      | 0.2048       | 0.2170    | 0.1009  | 0.2397    |
| Qwen3.5-9B Instruct | CAA                 | 0.2351       | 0.2527    | 0.1248  | 0.2603    |
| Qwen3.5-9B Instruct | SparseCAA           | 0.2625       | 0.2627    | 0.2251  | 0.1747    |
